    ...
    return(
        ...
        flex justify-center items-center flex-col p-[20px]">
            ...
            <div className={`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#020220] border-2 border-[#0000ff66] 
                                ...
                                hover:shadow-blue-950 cursor-pointer
                                    hover:border-4
                                    hover:border-white flex items-center justify-center ${selectedImage=="input"?
                                        "border-4 border-white hover:shadow-2xl shadow-blue-950":null}`} onClick={()=>{
        ...
        <input type="file" accept="image/*" ref={inputImage} hidden onChange={handleImage}/>
            ...
            text-black font-semibold cursor-pointer bg-white rounded-full text-[19px]" onClick={()=>navigate("/customize2")}>Next</button>}
        </div>
    )
}
